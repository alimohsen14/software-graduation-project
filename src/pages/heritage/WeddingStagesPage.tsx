...
// ================= Stage Card (Modified for Carousel) =================
const StageCard = ({
    title,
    short,
    image,
...
export default function WeddingStagesPage() {
    ...
    const nextSlide = () => {
        setCurrentIndex((prev) => (prev + 1) % palestinianWeddingData.length);
    };

    const prevSlide = () => {
        setCurrentIndex((prev) => (prev - 1 + palestinianWeddingData.length) % palestinianWeddingData.length);
    };
        ...
        <HeritageBackground>
            ...
            >
                ...
                <div className="flex gap-2 mt-4">
                    {palestinianWeddingData.map((_: any, index: number) => (
                        <div
                            key={index}
