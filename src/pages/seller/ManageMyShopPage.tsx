...
import { getMyStore, updateStoreDetails, uploadStoreLogo, SellerStore } from '../../services/seller.service';
...
export default function ManageMyShopPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            setIsSaving(true);
            const updatedStore = await updateStoreDetails({
                name: formData.name,
    ...
    const handleFileChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        try {
            ...
            const { logo } = await uploadStoreLogo(data);
            setLogoPreview(logo);
        ...
        <DashboardLayout>
            <div className="p-6 sm:p-10 min-h-screen">
                <div className="max-w-3xl mx-auto space-y-8">
                    <div>
                        <h1 className="text-2xl font-bold text-[#1d2d1f]">Manage My Shop</h1>
                        <p className="text-gray-500 mt-1">Update your store identity and details.</p>
                    </div>
