...
export default function ProfileHeaderCard({
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center sm:items-start sm:flex-row gap-5 md:gap-8 relative z-10">
        {/* Avatar Section */}
        ...
        <div className="flex-1 text-center sm:text-right flex flex-col justify-center">
          ...
          <div className="mt-6 md:mt-8 grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 text-right">
            ...
            <div className="flex flex-col gap-0.5">
              ...
              <span className="text-xs font-bold text-white uppercase tracking-tight capitalize">
