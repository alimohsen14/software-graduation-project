...
export default function ProfileInfoCard({
  ...
  return (
    <div
      dir={direction}
      className="bg-white/5 backdrop-blur-3xl rounded-[2rem] border border-white/10 shadow-2xl p-6 sm:p-8 flex flex-col md:flex-row items-center justify-between gap-6 relative overflow-hidden group animate-in slide-in-from-top-4 duration-700 delay-100"
    >
      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-4 w-full md:w-auto relative z-10">
